<template>
  <div class="app-container">
    ...
    <el-button type="text" @click="saveChapterDialog()">添加章节</el-button>
    <!-- 章节 -->
    <ul class="chanpterList">
      <li v-for="chapter in chapterSectionList" :key="chapter.id">
        <p>
          {{chapter.title}}
          <span class="acts">
            <el-button type="text" @click="saveSectionDialog(chapter.id)">添加小节</el-button>
            <el-button type="text" @click="updateChapterDialog(chapter.id)">修改</el-button>
