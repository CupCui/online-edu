...
public class Main {
    ...
    //账号AccessKey信息请填写(必选)
    private static String access_key_id = "LTAI4FxfCwTgvJx5KVWC3fFt";
    //账号AccessKey信息请填写(必选)
    private static String access_key_secret = "XQ6jWN2wzood9GSAUXN7I0JQY2vHIH";
...
//        privateParams.put("VideoId", "5aed81b74ba84920be578cdfe004af4b");
        privateParams.put("VideoId", "128378f1ac4f40f9ba91222c8f1080cd");
